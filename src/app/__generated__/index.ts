 ...
 * Checksum: 2/v9Fz1Ke5pu0Defj+/5q+513XvZvZ4PlImm5N2YBTc5qQNtumKOqscOVNg/5itvfkASEUiNlut53y/LBeFHKQ==
 */
...
import Actor, {Actor_InsertParameters} from './actor'
...
import Category, {Category_InsertParameters} from './category'
import City, {City_InsertParameters} from './city'
...
import Competition, {Competition_InsertParameters} from './competition'
...
import Countrylanguage, {Countrylanguage_InsertParameters} from './countrylanguage'
import Customer, {Customer_InsertParameters} from './customer'
...
import Faithful, {Faithful_InsertParameters} from './faithful'
...
import Film, {Film_InsertParameters} from './film'
import FilmActor, {FilmActor_InsertParameters} from './film_actor'
import FilmCategory, {FilmCategory_InsertParameters} from './film_category'
import FilmText, {FilmText_InsertParameters} from './film_text'
...
import Inventory, {Inventory_InsertParameters} from './inventory'
...
import Language, {Language_InsertParameters} from './language'
import LogStatus, {LogStatus_InsertParameters} from './log_status'
import Manjo, {Manjo_InsertParameters} from './manjo'
import Members, {Members_InsertParameters} from './members'
...
import Payment, {Payment_InsertParameters} from './payment'
...
import Register, {Register_InsertParameters} from './register'
import Rental, {Rental_InsertParameters} from './rental'
...
import Staff, {Staff_InsertParameters} from './staff'
...
import Store, {Store_InsertParameters} from './store'
...
import Test, {Test_InsertParameters} from './test'
...
interface DatabaseSchema {
  ...
  members: {record: Members, insert: Members_InsertParameters};
  ...
  faithful: {record: Faithful, insert: Faithful_InsertParameters};
  manjo: {record: Manjo, insert: Manjo_InsertParameters};
  test: {record: Test, insert: Test_InsertParameters};
  ...
  employee: {record: Employee, insert: Employee_InsertParameters};
  register: {record: Register, insert: Register_InsertParameters};
  actor: {record: Actor, insert: Actor_InsertParameters};
  address: {record: Address, insert: Address_InsertParameters};
  category: {record: Category, insert: Category_InsertParameters};
  city: {record: City, insert: City_InsertParameters};
  country: {record: Country, insert: Country_InsertParameters};
  customer: {record: Customer, insert: Customer_InsertParameters};
  film: {record: Film, insert: Film_InsertParameters};
  film_actor: {record: FilmActor, insert: FilmActor_InsertParameters};
  film_category: {record: FilmCategory, insert: FilmCategory_InsertParameters};
  film_text: {record: FilmText, insert: FilmText_InsertParameters};
  inventory: {record: Inventory, insert: Inventory_InsertParameters};
  language: {record: Language, insert: Language_InsertParameters};
  payment: {record: Payment, insert: Payment_InsertParameters};
  rental: {record: Rental, insert: Rental_InsertParameters};
  staff: {record: Staff, insert: Staff_InsertParameters};
  store: {record: Store, insert: Store_InsertParameters};
  sys_config: {record: SysConfig, insert: SysConfig_InsertParameters};
  committees: {record: Committees, insert: Committees_InsertParameters};
  competition: {record: Competition, insert: Competition_InsertParameters};
  members: {record: Members, insert: Members_InsertParameters};
  city: {record: City, insert: City_InsertParameters};
  country: {record: Country, insert: Country_InsertParameters};
  countrylanguage: {record: Countrylanguage, insert: Countrylanguage_InsertParameters};
}
